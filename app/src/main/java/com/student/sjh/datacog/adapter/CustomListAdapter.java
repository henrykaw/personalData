package com.student.sjh.datacog.adapter;
...
import android.widget.BaseAdapter;
import android.widget.TextView;
import com.student.sjh.datacog.R;
...
public class CustomListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View scoreView, ViewGroup parent) {
        ...
        if (scoreView == null) {
            ...
            holder.score1= (TextView) scoreView.findViewById(R.id.score1);
        ...
        holder.score1.setText(m.getScore1());
